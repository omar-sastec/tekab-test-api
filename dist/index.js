...
var HttpClient = /** @class */ (function () {
    function HttpClient(apiConfig) {
        ...
        this.baseUrl = "//146.59.200.81:8200";
...
var Api = /** @class */ (function (_super) {
    ...
    function Api() {
        ...
        _this.api = {
             ...
             * @secure
             */
            podcastByThemesCreate: function (mPodCastsByThemes, params) {
                if (params === void 0) { params = {}; }
                return _this.request(__assign({ path: "/api/podcast/by-themes", method: "POST", body: mPodCastsByThemes, secure: true, type: ContentType.Json, format: "json" }, params));
            },
            /**
             ...
             * @secure
             */
            podcastHomeList: function (query, params) {
                if (params === void 0) { params = {}; }
                return _this.request(__assign({ path: "/api/podcast/home", method: "GET", query: query, secure: true, format: "json" }, params));
            },
            /**
             ...
             * @secure
             */
            podcastInfosIdList: function (id, params) {
                if (params === void 0) { params = {}; }
                return _this.request(__assign({ path: "/api/podcast/infos/" + id, method: "GET", secure: true, format: "json" }, params));
            },
            /**
             ...
             * @secure
             */
            podcastMostPopularList: function (query, params) {
                if (params === void 0) { params = {}; }
                return _this.request(__assign({ path: "/api/podcast/most-popular", method: "GET", query: query, secure: true, format: "json" }, params));
            },
            /**
             ...
             * @secure
             */
            podcastMostVisitedList: function (query, params) {
                if (params === void 0) { params = {}; }
                return _this.request(__assign({ path: "/api/podcast/most-visited", method: "GET", query: query, secure: true, format: "json" }, params));
            },
        };
        return _this;
    }
